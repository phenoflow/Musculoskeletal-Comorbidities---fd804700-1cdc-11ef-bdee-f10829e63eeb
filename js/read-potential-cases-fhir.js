...
(async () => {
  ...
  await fs.writeFile("musculoskeletal-comorbidities-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("musculoskeletal-comorbidities-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
